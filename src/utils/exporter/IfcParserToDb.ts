import { IfcExportParser, formatGuid } from './IfcExportParser'
import { RelationElementInfo } from '../common/ifcUtils'
import * as duckdb from '@duckdb/duckdb-wasm';
import { resolveDuckDbBundles } from './duckdbWasmPath';
...
export class IFCParser2DB {
    private parser: IfcExportParser;
    ...
    constructor() {
        ...
        this.parser = new IfcExportParser({
            fileId: 'test'
        });
    ...
    private async initDb(dbName: string) {
        const MANUAL_BUNDLES: duckdb.DuckDBBundles = await resolveDuckDbBundles();
