        ...
        <TContent style="padding: 40px; background-color: #ffffff; overflow-y: auto;">
              ...
              <div style="margin-top: 24px; display: flex; gap: 16px; margin-bottom: 32px;">
                <div style="text-align: center;">
                  ...
                  <TTooltip content="打开IFC文件">
                    <TButton shape="square" variant="outline" @click="handleOpenFileClick" style="width: 96px; height: 96px; display: flex; justify-content: center; align-items: center;">
            ...
            <div v-if="activeMenu === 'language'">
              ...
              <div class="setting-cards-container">
                <div class="setting-card" :class="{ active: settingsStore.language === 'zh-CN' }" @click="handleLanguageChange('zh-CN')">
                ...
                <div class="setting-card" :class="{ active: settingsStore.language === 'en-US' }" @click="handleLanguageChange('en-US')">
                  <div class="card-content">
                    <TIconLanguage class="card-icon" />
                    <div class="card-text">
            ...
            <div v-if="activeMenu === 'theme'">
              ...
              <div class="setting-cards-container">
                <div v-for="color in themeColors" :key="color.value" class="setting-card theme-card" :class="{ active: settingsStore.themeColor === color.value }" @click="handleThemeChange(color.value)">
                  <div class="card-content">
...
const emit = defineEmits(['update:visible', 'request-open-file']);
